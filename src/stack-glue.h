...
/* NONE:STRING,UINT,STRING,STRING,STRING,BOXED,BOXED,INT,POINTER (/tmp/dbus-binding-tool-c-marshallers.FMQPPU:1) */
...
/* BOOLEAN:POINTER,POINTER,POINTER,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.FMQPPU:2) */
...
/* BOOLEAN:UINT,POINTER (/tmp/dbus-binding-tool-c-marshallers.FMQPPU:3) */
...
/* BOOLEAN:POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.FMQPPU:4) */
