...
/* NONE:STRING,UINT,STRING,STRING,STRING,BOXED,BOXED,INT,POINTER (/tmp/dbus-binding-tool-c-marshallers.THGQQU:1) */
...
/* BOOLEAN:POINTER,POINTER,POINTER,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.THGQQU:2) */
...
/* BOOLEAN:UINT,POINTER (/tmp/dbus-binding-tool-c-marshallers.THGQQU:3) */
...
/* BOOLEAN:POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.THGQQU:4) */
